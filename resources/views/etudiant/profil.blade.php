...
<div class="pt-4 max-w-2xl mx-auto">
    ...
    <div class="grid grid-cols-3 gap-4 mb-6">
        <div class="col-span-1 card flex flex-col items-center text-center py-8">
            ...
            <span class="mt-3 badge badge-blue">Étudiant</span>
        </div>
        ...
        <div class="col-span-2 card">
            ...
            <dl class="space-y-3">
                <div class="flex justify-between">
                    <dt class="text-xs text-slate-500 font-semibold uppercase">Matricule</dt>
                    <dd class="text-sm font-mono font-bold text-primary">{{ $etudiant->matricule }}</dd>
                </div>
                <div class="flex justify-between">
                    <dt class="text-xs text-slate-500 font-semibold uppercase">Filière</dt>
                    <dd class="text-sm text-slate-800">{{ $etudiant->filiere->nom_filiere }}</dd>
                </div>
                <div class="flex justify-between">
                    <dt class="text-xs text-slate-500 font-semibold uppercase">Cycle</dt>
                    <dd class="text-sm text-slate-800">{{ $etudiant->filiere->cycle->value }}</dd>
                </div>
                <div class="flex justify-between">
                    <dt class="text-xs text-slate-500 font-semibold uppercase">Niveau</dt>
                    <dd class="text-sm text-slate-800">Niveau {{ $etudiant->niveau }}</dd>
                </div>
                <div class="flex justify-between">
                    <dt class="text-xs text-slate-500 font-semibold uppercase">Département</dt>
                    <dd class="text-sm text-slate-800">{{ $etudiant->filiere->departement->nom_dep }}</dd>
                </div>
